...
本文件主体是 2026-09-21 的独立审查快照，原有“尚缺”与补验队列保留为历史。其后 root 已补齐并在正式 [验收矩阵](../ACCEPTANCE.md) 结账；其中 AC-36 的 [真实 Mac 睡眠验收](../evidence/mac-sleep-acceptance-20260922.md) 记录同一 PID/实例跨越 23,946 秒合盖休眠、唯一调度锁、有限预算、两段覆盖缺口、时间／版本语义、正式页面和正常停止。当前 AC-01—AC-36 与第 11.6 节均通过，PRD 工程 M1—M3 完成；PRD M4 的五议题七天、50/20/10 人工抽查及用户效率仍未执行。若本文件历史判读与当前矩阵冲突，以当前矩阵和日期更晚的原始证据为准。
